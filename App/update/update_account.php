...
if (isset($_POST['id'], $_POST['firstname'], $_POST['lastname'], $_POST['username'], $_FILES['img'])) {
    $id = $_POST['id'];
    $NIK = $_POST['NIK'];
    ...
    $query = "UPDATE users SET firstname='$firstname', lastname='$lastname', username='$username' $update_password $update_avatar WHERE id='$id'";
